...
React's `useRouteMatch` hook is used to make building relative route paths and link locations easier, by creating more generalized and flexible code.
1. How would you explain form validation to someone who has never programmed before?
Form validation ensures the user has submitted what the form requires, in the correct format.
1. In 1-2 sentences, define end to end testing.
End to end testing refers to testing an application's workflow from beginning to end.
